...
public class ExecutableUpsertByIdOperationSupport implements ExecutableUpsertByIdOperation {
	...
	static class ExecutableUpsertByIdSupport<T> implements ExecutableUpsertById<T> {
		...
		@Override
		public TerminatingUpsertById<T> withOptions(UpsertOptions options) {
			return new ExecutableUpsertByIdSupport<>(template, domainType, scope, collection, options, persistTo, replicateTo,
					durabilityLevel, expiry);
		}

		@Override
		public UpsertByIdWithCollection<T> inScope(String scope) {
			return new ExecutableUpsertByIdSupport<>(template, domainType, scope, collection, options, persistTo, replicateTo,
					durabilityLevel, expiry);
		}
		...
		@Override
		public UpsertByIdWithScope<T> withDurability(final DurabilityLevel durabilityLevel) {
		...
		@Override
		public UpsertByIdWithScope<T> withDurability(final PersistTo persistTo, final ReplicateTo replicateTo) {
